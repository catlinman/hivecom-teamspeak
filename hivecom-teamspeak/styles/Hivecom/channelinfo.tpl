...
<table id="header">
	...
	<tr><td class="headersub"><span></span>%%?CHANNEL_TOPIC%%</td></tr>
</table>
</table>
...
<table id="container">
	<td><table id="info">    
		<tr><td class="user"><table>
			...
			<tr><td class="infotext">Current Clients:</td><td class="infotext">%%?CHANNEL_CLIENTS_COUNT%%</td></tr>
			<tr><td class="infotext">Max Clients:</td><td class="infotext">%%CHANNEL_FLAG_MAXCLIENTS%%</td></tr>
